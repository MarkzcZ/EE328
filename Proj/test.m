...
%Reading a file and getting the fundamental,zero crossing, short energy values
...
Speech_Score=0.25*(freq/fundamental_freq_level)+(zero_cross/zero_crossing_level)*0.35+(0.4*short_ene/short_energy_level);
